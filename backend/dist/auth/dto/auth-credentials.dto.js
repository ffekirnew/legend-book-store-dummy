...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(20),
    (0, class_validator_1.Matches)(/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]+$/, { message: "password needs to contain at least one uppercase letter, one lowercase letter, one number, and one symbol" }),
    __metadata("design:type", String)
